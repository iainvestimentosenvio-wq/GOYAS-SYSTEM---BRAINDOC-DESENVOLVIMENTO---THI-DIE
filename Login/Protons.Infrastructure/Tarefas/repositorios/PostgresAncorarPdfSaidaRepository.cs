...
public sealed class PostgresAncorarPdfSaidaRepository : IAncorarPdfSaidaRepository
{
    ...
    public PostgresAncorarPdfSaidaRepository(PostgresDb db, TimeProvider? timeProvider = null)
    {
        _db = db;
...
LIMIT 1;";
    ...
    private static void Bind(NpgsqlCommand cmd, SaidaVariavelAncorada s)
    {
    ...
    private SaidaVariavelAncorada Map(NpgsqlDataReader r)
    {
    ...
    private DateTime ReadDate(NpgsqlDataReader r, string col)
    {
        ...
        throw new FormatException($"Valor de data invalido em {nameof(PostgresAncorarPdfSaidaRepository)}.{col}: '{raw}'.");
    }
}
